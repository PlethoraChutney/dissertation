...
It should come as no surprise that expression of ENaC is under tight control, given the number of important processes ENaC is implicated in.[There is a great body of research on the regulation of ENaC in *X. laevis*. Unfortunately, its expression and regulation patterns do not agree well with what is observed in humans and rodents. I focus here on mammalian ENaC regulation, as it is more relevant to this work.]{.aside}
...
ENaC is constitutively expressed in tissues in the kidney, colon, lung, and other tissues.
In the kidney, the &alpha; subunit expressed at significantly higher levels than the &beta; or &gamma; subunits.
When rats are treated with aldosterone, the cortical collecting tubules increase translation of &beta; and &gamma; (but not &alpha;) ENaC [@asher1996].
The increased translation occurs on a time scale of between three and twenty-four hours.

The exact amount of increase for each subunit varies tissue to tissue, but generally aldosterone induces expression of &beta; and &gamma;ENaC, while &alpha;ENaC is constitutively expressed <!-- TODO: cite -->.
However, as covered in @sec-intro_enac-in-body, not all tissues express all three ENaC subunits.

<!-- TODO: come back and write up the aldosterone section -->
...
Liddle syndrome (@sec-intro_liddle) is most often caused by the disruption of the Nedd4-2/ENaC interaction, and so is a perfect illustration of the regulatory mechanism.
Binding of ENaC and subsequent ubiquitination recycles the protein from the cell surface, reducing cellular Na^+^ permeability.

#### Nedd4-2 Structure

Like many members of the HECT ligase family, Nedd4-2 has an N-terminal C2 domain, a number of WW domains, and a C-terminal HECT domain.
...
All three domains of murine Nedd4 are required, in heterologous systems, for ENaC suppression [@harvey99].
Human Nedd4-2 without the first WW domain can still bind ENaC [@fotia02].
...
The HECT domain is highly regulated.
...
Nedd4-2 is expressed in response to 
It binds and ubiquitinates ENaC on N-terminal lysines, causing the channels to be internalized and recycled in either the lysosome or proteasome [@goulet1998; @malik2001; @staub97].[Interestingly, ubiquitination of &alpha;ENaC seems to require lysines on the &gamma; subunit [@staub97].]{.aside}
Degradation of ENaC in this fashion only occurs with a high-salt diet [@kellenberger1998].

The functional importance of the C2 domain for ENaC regulation is unclear.
...
In fact, C2-less Nedd4 suppresses ENaC currents more than WT Nedd4 in heterologous systems, indicating that the auto-inhibitory role of the C2 domain may be what prevents Nedd4 regulation of ENaC *in vivo* given the similarity of their WW domains [@snyder01; @kamynina2001].
However, mice expressing Nedd4-2 without a C2 domain fail to regulate ENaC in response to a high-salt diet and develop hypertension [@minegishi16].
