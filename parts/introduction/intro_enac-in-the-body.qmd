...
<!-- TODO: ENaC mechanism crossref --> delves more deeply into the suspected molecular mechanism of ENaC gating and the source of its selectivity.
...
While this chapter may seem unnecessarily detailed for our purposes, I believe it is important to understand both ENaC's role in several human diseases, as well as the degree to which mouse models fail to recapitulate those diseases.
...
SGK both directly regulates ENaC P~O~ and the ability of Nedd4-2 (@sec-intro_nedd42) to mark ENaC for degradation [@kellenberger98; @chen1999].
...
Mice lacking SGK present a salt-wasting phenotype and high serum aldosterone, similar to the symptoms seen in PHA1 patients (@sec-intro_liddle) [@wulff2002].
...
SGK is itself, in turn, ubiquitinated by Nedd4-2 [@zhou2005].
...
SGK also directly interacts with and phosphorylates &alpha;ENaC[@diakov2004; @thomas2011].
