...
Aldosterone is the primary means by which the body regulates Na^+^ retention.
It fills this role both by directly regulation gene expression of ENaC, but also by controlling expression and function of an array of other proteins which regulate ENaC.
When the kidney is not receiving enough salt, it initiates a cascade which ends with the mineralocorticoid hormone aldosterone augmenting the activity of ENaC in the distal nephron.[For a review of the Renin-Angiotensin-Aldosterone System (RAAS) consider Weir and Dzau [@wiesner07].]{.aside}
The exact molecular mechanism by which aldosterone increases ENaC at the apical surface is still not well understood, but it involves some combination of new protein synthesis and trafficking of an existing pool of channels to the cell surface [@asher1996; @frindt09; @weisz2000; @loffing2000].
In some studies, aldosterone increases transcription of the &beta;- and &gamma;- (but not &alpha;-) ENaC genes [@asher1996; @may1997; @stockand2000].
In others, increases in &alpha;ENaC transcription are also (or exclusively) observed [@masilamani1999; @dagenais2001; @loffing2000; @mick2001].
...
Degradation of ENaC is significantly augmented in a high-salt diet [@kellenberger98].
