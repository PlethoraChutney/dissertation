...
The exact molecular mechanism by which aldosterone increases ENaC at the apical surface is still not well understood, but it involves some combination of new protein synthesis and trafficking of an existing pool of channels to the cell surface [@asher1996; @frindt09].
Interestingly, aldosterone increases transcription of the &beta;- and &gamma;- (but not &alpha;-) ENaC genes [@asher1996; @may1997].
