...
However, &alpha;ENaC is sufficient to form small (100 times smaller than &alpha;&beta;&gamma;) currents when expressed alone in oocytes [@canessa1994].
...
In this section I provide a general, by no means exhaustive review of proteins known to regulate ENaC.
The exact molecular mechanisms by which ENaC P~O~ is modulated are covered in @sec-intro_direct-reg.
...
The majority of aldosterone's effect in the early phase is due to increased P~O~ of existing channels, rather than delivery of new channels to the cell surface [@frindt2015].
