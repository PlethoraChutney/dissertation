...
Like all members of the HECT ligase family, Nedd4-2 has an N-terminal C2 domain, a number of WW domains, and a C-terminal HECT domain.
...
The importance of the C2 domain is unclear.
In heterologous systems, Nedd4 is able to inhibit ENaC currents with or without a C2 domain, and both rats and humans express splice variants of Nedd4-2 which is missing the C2 domain [@snyder2000; @itani03; @umemura2006].
However, mice with their Nedd4-2 C2 domain knocked out fail to regulate ENaC in response to a high-salt diet and develop hypertension [@minegishi16].