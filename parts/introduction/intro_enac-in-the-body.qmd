...
The functional importance of the C2 domain is unclear.
In heterologous systems, both Nedd4 and Nedd4-2 are able to inhibit ENaC currents with or without a C2 domain, and both rats and humans express splice variants of Nedd4-2 which is missing the C2 domain [@snyder2000; @itani03; @itani05; @umemura2006].
...
It seems likely in any case that a great deal of substrate targeting depends instead on the WW domains.
