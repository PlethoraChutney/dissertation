...
If this simple sum of gaussians model does not fit, you could consider adding a constant (steady baseline&nbsp;&ne;&nbsp;0) or linear function (linearly changing baseline, fitting slope and intercept) to the fit formula.
