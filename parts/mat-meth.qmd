...
As expected based on our previous studies of electrophysiology of the Fab-bound channels, our ECD models with and without Fab are largely indistinguishable (@fig-fab-compare B,C)[@noreng20].
...
Model quality was assessed using MolProbity within Phenix, Q-scores calculated in ChimeraX, and 3DFSC as implemented in cryoSPARC (@tbl-model-building and @sec-validation)[@williams2018; @pintilie2020; @aiyer2021].

## Constructs
<!-- TODO: fix LaTeX table output -->
```{r}
#| echo: false
#| warning: false
#| error: false
...
particles <- read_csv('../figures/matmeth/table-one/model-building.csv', na = '')
models <- read_csv('../figures/matmeth/table-one/processed_tables.csv', col_types = 'cccccccc')
...
Finally, a **trypsin solution** (KCl external solution + 5 $\mu$g/mL trypsin) was prepared.
